    ...
    <table style="border:1px solid black">
        ...
        if ($numr > 0) {
            for ($i = 0; $i < $numr; $i++) {
                ...
                echo '<td><input type="checkbox" name="selectedTshirts[]" value="' . $fila["id"] . ' "/></td>';
                echo "</tr>";
            }
        }
        ?>
...
if (isset($_POST['selectedTshirts'])) {
    $_SESSION['tshirt'] = $_POST['selectedTshirts'];
    header("Location: 02trousers.php");
}
?>
