...
?>
<form action="03shoes.php" method="post">
    <h1>El corte Inglés - Shoes</h1>
    <table style="border:1px solid black">
        ...
        if ($numr > 0) {
            for ($i = 0; $i < $numr; $i++) {
                ...
                echo '<td><input type="checkbox" name="selectedShoes[]" value="' . $fila["id"] . ' "/></td>';
                echo "</tr>";
            }
        }
        ?>
...
if (isset($_POST['selectedShoes'])) {
    $_SESSION['shoes'] = $_POST['selectedShoes'];
    header("Location: 04checkout.php");
}
?>
